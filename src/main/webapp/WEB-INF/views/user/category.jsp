			...
			<div class="box-m-right">
				...
				<div class="row main-content">
					<div class="col-md-9 box-test">
						<div class="row">
							<c:forEach items="${newsByCategory.data}" var="o">
								<div class="news-content col-md-6">
									<a href="#" ><img src="${base}/uploads/${o.avatar}"
										class="img-fluid"></a>
									<div class="text-content">
										 <a href="${base}/detail/${o.seo}" class="link-to-go"><strong>${o.title}</strong></a>
										<div class="detail">${o.createdDate}</div>
										<p>${o.shortDes}</p>
									</div>
								</div>
							</c:forEach>
					...
					<hr>
					<div class="box-m-bottom">
						<ul class="pagination">
							<li class="pagination-item"><a href="#"
								class="pagination-item-link"> <i
									class="pagination-item-link-icon fas fa-angle-left"></i>
							</a></li>
							<li class="pagination-item"><a href="#"
							...
							<li class="pagination-item"><a href="#"
								class="pagination-item-link">14</a></li>
							<li class="pagination-item"><a href="#"
								class="pagination-item-link"> <i
									class="pagination-item-link-icon fas fa-angle-right"></i>
							</a></li>
						</ul>
					</div>
				</div>
