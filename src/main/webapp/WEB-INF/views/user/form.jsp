...
<body>
  ...
  <div class="container-box-mid">
    <div class="box-m-left">
      ...
      <ul><a href="#" style="font-size: 20px; text-decoration: none;">Tin tức</a>
    ...
    <div class="box-m-right">
      <div class="box-r-img">
        <img src="${base}/image/sliden.png" style="width: 100%; height: auto;">
      </div>
      <div class="row main-content">
      <div class="col-md-9 box-test">
        <!-- table ở đây -->
        <div class="table-title">
          <div class="form-button"><h5>Biểu mẫu</h5></div>
          <h3>Biểu mẫu và quy định dành cho sinh viên</h3>
          <div class="blue-line" style="width: 10%;"></div>
          <p><i>Cập nhật lần cuối: 23/02/2022 22:12</i></p>
        </div>
         ...
         <table class="table table-bordered" >
          <thead>
            <tr>
              ...
              <th scope="col">Hình thức/Hướng dẫn</th>
              <th scope="col">Xem/Tải lại</th>
            </tr>
          </thead>
          <tbody>
          
         <c:forEach items="${forms.data}" var="o">
            <tr>
              <th scope="row">1</th>
              <td>${o.name}</td>
              <td ><p>${o.tutorial}</p></td>
               <td ><a href="${base}/uploads/${o.link}"download><p>xem tải xuống biểu mẫu</p></a></td>
