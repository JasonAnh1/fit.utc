	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-9">
				<h4>Thêm bài viết</h4>
				<br>
				<sf:form class="form-horizontal" action="${base}/admin/updateNews" method="POST" modelAttribute="news" enctype="multipart/form-data" >
				<sf:hidden path="id"/>
					...
					<div class="form-group">
						...
						<div class="form-group">
							<label class="control-label col-sm-2" for="fileProductPictures">Các file tải về trong bài viết(Có thể nhập nhiều file):</label>
							<div class="col-sm-10">
						...
						<div class="form-group">
							<label class="control-label col-sm-2" for="fileProductAvatar">Avatar của bài viết hiện lên trang chủ:</label>
							<div class="col-sm-10">
