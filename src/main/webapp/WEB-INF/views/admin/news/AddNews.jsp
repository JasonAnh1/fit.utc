	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-9">
				<h4>Thêm bài viết</h4>
				<br>
				<sf:form class="form-horizontal" action="${base}/admin/addNews"
					...
					<div class="form-group" hidden="">
						<label class="control-label col-sm-2" for="name">Người tạo</label>
						<div class="col-sm-10">
							<sf:input type="text" class="form-control" id="createdBy"
								name="createdBy" placeholder="createdBy" path="createdBy"
								value="${userLogined.username}"></sf:input>
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-2">Đề mục:(Không được
							để trống) </label>
						<div class="col-sm-10">
					...
					<div class="form-group">
						<label class="control-label col-sm-2"> Sapo:(Không được để
							trống )</label>
						<div class="col-sm-10">
					...
					<div class="form-group">
						<label class="control-label col-sm-2"> Chi tiết nội
							dung:(Không được để trống)</label>
						<div class="col-sm-10">
					...
					<div class="form-group">
						<label class="control-label col-sm-2" for="fileProductAvatar">Avatar
							của bài viết hiện lên trang chủ:</label>
						<div class="col-sm-10">
							<input id="fileNewsAvatar" name="newsAvatar" type="file"
